...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50 relative">
        ...
        <script>
            // Fungsi untuk menyembunyikan atau menampilkan menu berdasarkan ukuran layar
            function handleResize() {
                const ulElement = document.querySelector('nav .flex > ul');
                if (window.innerWidth < 768) { // ukuran < MD (768px)
