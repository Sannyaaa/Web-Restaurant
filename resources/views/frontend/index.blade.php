...
@section('content')
    <div class="bg-yellow-300 mt">
        <div class="relative isolate px-6 lg:px-8">
            <div class="w-full md:flex py-16 lg:py-20 px-2 md:px-14 lg:px-20 xl:px-32 space-y-10">
                <div class="w-full md:w-4/5 flex justify-center items-center pe-10">
                    <div class="text-left w-full">
                        <h1 class="text-5xl font-bold  text-slate-800 md:text-6xl lg:text-7xl xl:text-8xl font-one">Welcome to <span class="text-white">Our </span>Cozy
                             <span class="text-white">Restaurant</span></h1>

                        <p class="mt-6 text-base md:text-lg  text-gray-600">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua. Qui irure qui lorem cupidatat commodo.</p>

                        <div class="mt-6 inline-flex items-center gap-x-6">
                            <a href="{{ route('list-menu') }}" class="px-4 md:px-6 py-3 transition-all bg-slate-800 text-white hover:bg-white border-slate-800 border-4 hover:text-slate-800 rounded-xl font-bold text-base md:text-lg">Explore Menu</a>
                            <a href="{{ route('contact-us') }}" class="px-4 md:px-6 py-3 transition-all bg-white hover:text-white hover:bg-slate-800 border-slate-800 border-4  text-slate-800 rounded-xl font-bold text-base md:text-lg">Contact Us</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-zinc-50">
        <div class="py-24">
            ...
            <div class="mt-6">
                <div class="text-center w-4/5 md:w-2/5 mx-auto">
                    <h1 class="text-4xl font-bold  text-slate-800 md:text-5xl lg:text-6xl font-one">Our <span class="text--300">Feature</span></h1>

                    <p class="mt-6 text-base md:text-lg  text-gray-600">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</p>
                </div>
                <div class=" md:mt-6 px-4 sm:px-16 lg:px-32">
                    <div class="w-full flex flex-wrap justify-center">
                        <div class="p-2 md:p-6 max-w-sm md:w-1/2 lg:w-1/3">
                            <div class="p-6">
                                <div class="">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="mt-2 text-sm md:text-base text-gray-600">Browse our digital menu with ease, featuring high-resolution images and detailed descriptions.</p>
                                </div>
                            </div>
                        </div>
                        <div class="p-2 md:p-6 max-w-sm md:w-1/2 lg:w-1/3">
                            <div class="p-6">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="mt-2 text-sm md:text-base text-gray-600">Relax in our urban jungle-inspired interior, freshly brewed to perfection, designed to make you feel at home.</p>
                                </div>
                            </div>
                        </div>
                        <div class="p-2 md:p-6 max-w-sm md:w-1/2 lg:w-1/3">
                            <div class="p-6">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="mt-2 text-sm md:text-base text-gray-600">All our menu items come with detailed nutritional information, so you know exactly what you're eating.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="my-32">
                ...
                <div class="my-12 sm:px-16 lg:px-40">
                            ...
                            @forelse ($categories as $category)
                                <div class="p-2 md:p-4 bg-opacity-100">
                                    <a href="{{ route('list-menu-category',$category->id) }}" class="flex flex-col justify-center items-center">
                                        ...
                                        <span class="text-sm md:text-base font-semibold px-4 md:px-6 py-2 md:py-3 rounded-full {{ isset($selectedCategory) && $selectedCategory->id == $category->id ? 'bg-slate-800 text-white' : 'bg-white' }} -mt-8 shadow-lg hover:shadow-2xl transition-all">{{ $category->name }}</span>
                                    </a>
                                </div>
                            @empty
            ...
            <div class="w-full px-4 sm:px-16 lg:px-32 space-y-10 mt-16 bg-yellow-300">
                <div class="px-4 md:px-10 md:flex">
                    <div class="w-full md:w-2/4 px-0 md:px-8 mx-auto my-auto">
                        <div class="overflow-hidden">
                    ...
                    <div class="w-full md:w-3/4 flex justify-center items-center">
                        <div class="text-left w-full pb-20 md:pt-20">
                            ...
                            <p class="mt-6 text-base md:text-lg  text-gray-600">With over 20 years of experience in the culinary industry, Chef Alexander Hamilton has honed his craft in some of the most prestigious kitchens around the world. His passion for combining fresh, local ingredients with innovative techniques has earned him a reputation as a leader in the culinary community.</p>
                        
                            <div class="mt-10">
                                <a href="{{ route('list-menu') }}" class="px-6 md:px-8 py-3 md:py-4 transition-all bg-slate-800 text-white hover:bg-white border-slate-800 border-4 hover:text-slate-800 rounded-xl font-bold text-lg">Explore Menu</a>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="swiper-slide group hover:bg-yellow-300 bg-white shadow-xl border-solid border-4 border-slate-800 rounded-2xl p-6 transition-all duration-500 hover:shadow-xl">
                                                    <div class="flex items-center gap-5 mb-5 sm:mb-5">
                                                        @if ($feedback->user->avatar)
                                                            <img class="w-10 h-10 rounded-full" src="{{ Storage::url($feedback->user->avatar) }}" alt="user photo">
                                                        @else
