                ...
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-full max-w-full px-3">
                    <div class="mb-4 flex justify-between">
                      ...
                      <div>
                        <h3 class=" text-3xl font-bold dark:text-white text-slate-800">
                            EDIT MODIFIER
                        </h3>
                      </div>
                    ...
                    <div class="relative overflow-x-auto">
                        <form action="{{ route('modifier.update',$modifier->id) }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="lg:col-span-2">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" value="{{ $modifier->name }}" name="name" id="name" class="h-10 border-4 border-slate-900 mt-1 rounded-md py-5 px-4 w-full bg-gray-50" value="" />
                                    @error('name')
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="number" name="price" id="price" class="h-10 border-4 border-slate-900 mt-1 rounded-md py-5 px-4 w-full bg-gray-50" value="{{ $modifier->price }}" />
                                    @error('price')
                                ...
                                <div class="md:col-span-2">
                                    <label for="category">Category <span class="text-rose-500">*</span></label>
                                    <select id="category" name="category" class="h-12 mt-1 bg-gray-50 border-4 border-slate-900 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                        <option value="" selected>Choose Category</option>
                                        <option value="food" {{ $modifier->category == 'food' ? 'selected' : '' }}>Food</option>
                                        <option value="drinks" {{ $modifier->category == 'drinks' ? 'selected' : '' }}>Drinks</option>
                                    </select>
                                </div>
                                ...
                                <div class="md:col-span-6 my-3 flex justify-between mx-4">
                                    <div class="inline-flex">
                                        <a href="{{ route('modifier.index') }}" class=" bg-slate-800 hover:bg-slate-900 px-8 py-3 text-lg font-bold text-white rounded-lg">Back</a>
                                    </div>
