                ...
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-full max-w-full px-3">
                    <div class="mb-4 flex justify-between">
                      ...
                      <div>
                        <h3 class="text-3xl font-bold text-slate-800 dark:text-white capitalize">
                            NEW MODIFIER
                        </h3>
                      </div>
                    </div>
                    ...
                    <div class="relative overflow-x-auto">
                        <form action="{{ route('modifier.store') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('POST')
                            <div class="lg:col-span-2">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="name" id="name" value="{{ old('name') }}" class="h-10 border-4 border-slate-900 mt-1 rounded-md py-5 px-4 w-full bg-gray-50" value="" />
                                    @error('name')
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="number" name="price" id="price" value="{{ old('price') }}" class="h-10 border-4 border-slate-900 mt-1 rounded-md py-5 px-4 w-full bg-gray-50" value="" />
                                    @error('price')
                                ...
                                <div class="md:col-span-5 mt-3 flex justify-between mx-4">
