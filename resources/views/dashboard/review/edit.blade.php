                    ...
                    <div class="relative overflow-x-auto">
                        <form action="{{ route('review.update',$review->id) }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-x-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-2">
                                    ...
                                    <div class=" col-span-1">
                                        <div class=" text-base font-medium">
                                            ...
                                            <select id="is_show" name="is_show" class="bg-gray-50 border-4 border-slate-800 text-gray-900 text-sm rounded-lg mt-1 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option value="yes" {{ $review->is_show == 'yes' ? 'selected' : '' }} >Yes</option>
                                                <option value="no" {{ $review->is_show == 'no' ? 'selected' : '' }} >No</option>
                                            </select>
                                        </div>
                                        @error('is_show')
                                            <div class="my-4 py-4 px-6 bg-rose-200 rounded-lg">
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <textarea name="comment" id="comment" class="h-32 mt-1 rounded-md border-4 border-slate-900 p-4 w-full bg-gray-50" placeholder="comment...">{{ $review->comment }}</textarea>
                                        @error('comment')
                                            <div class="my-4 py-4 px-6 bg-rose-200 rounded-lg">
                                                <div class="alert alert-success text-md text-rose-700">
                                                    {{ $message }}
                                    ...
                                    <div class="md:col-span-5 my-3 flex justify-between mx-4">
                                        <div class="inline-flex">
                                            <a href="{{ route('review.index') }}" class=" bg-slate-800 hover:bg-slate-900 px-8 py-3 text-lg font-bold text-white rounded-lg">Back</a>
                                        </div>
