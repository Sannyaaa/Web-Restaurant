              ...
              <div class="flex-auto p-10">
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-full max-w-full px-3">
                    ...
                    <form id="bulk-action-form" action="{{ route('bulk.action.review') }}" method="POST">
                        @csrf
                                                ...
                                                <td class="px-6 py-4 flex gap-3">
                                                    @can('update',$review)
                                                        <div class="flex items-center">
                                                            <a href="{{ route('review.edit',$review->id) }}" class="z-10 rounded-2xl bg-white px-6 py-2 text-lg font-bold text-slate-800 border-8 border-green-700 hover:-translate-x-2 hover:-translate-y-2 transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-600">Edit</a>
                                                    ...
                                                    @endcan
                                                    @can('delete',$review)
                                                        <form action="{{ route('review.destroy', $review->id) }}" method="POST"  onsubmit="return confirm('yakin mau hapus?');">
                                                            @csrf
                                                            @method('DELETE')
                                                            <div class="flex items-center">
