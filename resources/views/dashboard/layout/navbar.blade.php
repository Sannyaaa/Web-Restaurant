      ...
      <nav class="relative flex flex-wrap items-center justify-between px-0 py-2 mx-6 transition-all ease-in shadow-none duration-250 rounded-2xl lg:flex-nowrap lg:justify-start" navbar-main navbar-scroll="false">
        <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
          ...
          <div class="gap-3 flex items-center mt-2">
            ...
            <nav>
              <!-- breadcrumb -->
              <ol class="flex flex-wrap font-semibold mr-12 bg-transparent rounded-lg sm:mr-16">
                <li class="text-lg leading-normal">
                  <a class="text-slate-800 {{  View::hasSection('title-page') != null ? 'opacity-50' : 'opacity-100'}}" href="javascript:;">Dashboard</a>
                </li>
                {{-- <li class="text-md pl-2 capitalize leading-normal text-white before:float-left before:pr-2 before:text-white before:content-['/']" aria-current="page">Dashboard</li> --}}
                @if (View::hasSection('title-page') != null )
                    <li class="nav-item text-md pl-2 capitalize leading-normal text-slate-800 before:float-left before:pr-2 before:text-white">
                        / @yield('title-page')
                    </li>
                @endif
              </ol>
          ...
          <div class="flex justify-start items-center">
              <form action="#" method="GET" class="hidden lg:block lg:pl-2">
                ...
                <div class="relative mt-1 lg:w-96">
                  ...
                  <input type="text" name="email" id="topbar-search" class="bg-gray-50 border-4 border-slate-800 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-9 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search">
                </div>
              </form>
            </div>
