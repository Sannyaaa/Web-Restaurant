                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-2">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="number" name="price" id="price" value="{{ old('price') ?? '' }}" class="h-10 border-4 border-slate-900 mt-1 rounded-md py-5 px-4 w-full bg-gray-50" value="" placeholder="" />
                                        @error('price')
                                            <div class="my-4 py-2 px-6 bg-rose-200 rounded-lg">
                                                <div class="alert alert-success text-md text-rose-700">
                                                    {{ $message }}
                                    ...
                                    <div class="">
                                        ...
                                        <textarea name="description" id="editor1" class="" placeholder="Description...">{{ old('description') ?? '' }}</textarea>
                                        @error('description')
                                            <div class="my-4 py-4 px-6 bg-rose-200 rounded-lg">
                                                <div class="alert alert-success text-md text-rose-700">
                                                    {{ $message }}
                                    ...
                                    <div class="">
                                        ...
                                        <textarea name="ingredient" id="editor2" style="" class="border-4 border-slate-800" placeholder="ingredient...">{{ old('ingredient') ?? '' }}</textarea>
                                        @error('ingredient')
                                            <div class="my-4 py-4 px-6 bg-rose-200 rounded-lg">
                                                <div class="alert alert-success text-md text-rose-700">
                                                    {{ $message }}
                                ...
                                <div class="md:col-span-1 my-3 flex justify-between mx-4">
