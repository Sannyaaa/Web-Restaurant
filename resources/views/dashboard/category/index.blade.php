                    ...
                    <div class=" flex justify-between mb-4">
                      ...
                      <div>
                        <div class="flex items-center gap-x-6">
                            <a href="{{ route('category.create') }}" class="w-full rounded-lg bg-yellow-300 hover:bg-yellow-400 px-8 py-3 text-lg font-bold text-slate-800 transition-all ">New Category</a>
                        </div>
                      </div>
                    </div>
                    
                    <form id="bulk-action-form" action="{{ route('bulk.action.category') }}" method="POST">
                        @csrf
                                ...
                                <tbody>
                                    {{-- @forelse ($categories as $category)
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="">
                                                    <img src="{{ Storage::url($category->image) }}" class="max-h-48" alt="">
                                                </div>
                                            </td>
                                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            ...
                                            <td class="px-6 py-4 flex gap-3">
                                                ...
                                                <form action="{{ route('category.destroy', $category->id) }}" method="POST"  onsubmit="return confirm('yakin mau hapus?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="flex items-center">
