                        ...
                        <form action="{{ route('category.store') }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <div class="md:col-span-4">
                                    ...
                                    <label for="description">Description <span class="text-rose-500">*</span></label>
                                    <textarea name="description" id="description" class="h-32 mt-1 rounded-md border-4 border-slate-900 p-4 w-full bg-gray-50" placeholder="Description...">{{ old('description') ?? '' }}</textarea>
                                    @error('description')
                                        <div class="my-4 py-4 px-6 bg-rose-200 rounded-lg">
                                            <div class="alert alert-success text-md text-rose-700">
                                                {{ $message }}
                                ...
                                <div class="md:col-span-5 mt-3 flex justify-between mx-4">
                                    <div class="inline-flex">
                                        <a href="{{ route('category.index') }}" class=" bg-slate-800 hover:bg-slate-900 px-8 py-3 text-lg font-bold text-white rounded-lg">Back</a>
                                    </div>
