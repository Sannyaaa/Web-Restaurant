                ...
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-full max-w-full px-3">
                    ...
                    <div class="relative overflow-x-auto">
                        <div class="border-4 border-slate-900 mt-1 rounded-xl w-fit overflow-hidden">
                        ...
                        <form action="{{ route('category.update',$category->id) }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" value="{{ $category->name }}" name="name" id="name" class="h-10 border-4 border-slate-900 mt-1 rounded-md py-5 px-4 w-full bg-gray-50" value="" />
                                    @error('name')
                                ...
                                <div class="md:col-span-4">
                                    ...
                                    <textarea name="description" id="description" class="h-32 mt-1 rounded-md border-4 border-slate-900 p-4 w-full bg-gray-50" placeholder="Description...">{{ $category->description }}</textarea>
                                    @error('description')
                                        <div class="my-4 py-4 px-6 bg-rose-200 rounded-lg">
                                            <div class="alert alert-success text-md text-rose-700">
                                                {{ $message }}
