                ...
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-full max-w-full px-3">
                    <div class="mb-4 flex justify-between">
                      <div>
                        <h3 class="text-3xl font-bold text-slate800 dark:text-white">
                            EDIT FEEDBACK
                        </h3>
                      </div>
                    </div>
                    ...
                    <div class=" overflow-x-auto">
                        <form action="{{ route('feedback.update',$feedback->id) }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class=" grid-cols-1">
                                <div class="grid gap-4 text-sm grid-cols-1 md:grid-cols-2">             
                                    ...
                                    <div class=" col-span-1">
                                        <div class="w-full">
                                            <label for="is_show">Tampilkan / Tidak</label>
                                            <select id="is_show" name="is_show" class="bg-gray-50 border-4 border-slate-800 text-gray-900 text-sm rounded-lg mt-1 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option value="yes" {{ $feedback->is_show == 'yes' ? 'selected' : '' }} >Yes</option>
                                                <option value="no" {{ $feedback->is_show == 'no' ? 'selected' : '' }} >No</option>
                                            </select>
                                        </div>
                                        @error('is_show')
                                            <div class="my-4 py-4 px-6 bg-rose-200 rounded-lg">
                                ...
                                <div class="grid gap-4 text-sm grid-cols-1 md:grid-cols-2">
                                    ...
                                    <div class=" col-span-1">
                                        <div class="w-full">
                                            ...
                                            <input type="text" name="name" id="name" class="h-10 border-4 border-slate-900 mt-1 rounded-md py-5 px-4 w-full bg-gray-50" value="{{ $feedback->name }}" />
                                        </div>
                                        @error('name')
                                            <div class="my-4 py-4 px-6 bg-rose-200 rounded-lg">
                                                <div class="alert alert-success text-md text-rose-700">
                                    ...
                                    <div class=" col-span-1">
                                        <div class="w-full">
                                            ...
                                            <input type="text" name="phone" id="phone" class="h-10 border-4 border-slate-900 mt-1 rounded-md py-5 px-4 w-full bg-gray-50" value="{{ $feedback->phone }}" />
                                        </div>
                                        @error('phone')
                                            <div class="my-4 py-4 px-6 bg-rose-200 rounded-lg">
                                                <div class="alert alert-success text-md text-rose-700">
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <textarea name="message" id="message" class="h-32 mt-1 rounded-md border-4 border-slate-900 p-4 w-full bg-gray-50" placeholder="message...">{{ $feedback->message }}</textarea>
                                        @error('message')
                                            <div class="my-4 py-4 px-6 bg-rose-200 rounded-lg">
                                                <div class="alert alert-success text-md text-rose-700">
                                                    {{ $message }}
                                    ...
                                    <div class="md:col-span-5 my-3 flex justify-between mx-4">
                                        <div class="inline-flex">
                                            <a href="{{ route('feedback.index') }}" class=" bg-slate-800 hover:bg-slate-900 px-8 py-3 text-lg font-bold text-white rounded-lg">Back</a>
                                        </div>
