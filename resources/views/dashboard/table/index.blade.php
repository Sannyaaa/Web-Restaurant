                ...
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-full max-w-full px-3">
                    <div class="flex justify-between mb-4">
                      ...
                      <div>
                        <h3 class="mb-2 text-3xl font-bold dark:text-white text-slate-800">
                            TABLE
                        </h3>
                        <p class="mb-0 dark:text-white dark:opacity-60 text-slate-800">
                      ...
                      <div>
                        <div class="flex items-center gap-x-6">
                            <a href="{{ route('table.create') }}" class="w-full rounded-lg bg-yellow-300 hover:bg-yellow-400 px-8 py-3 text-lg font-bold text-slate-800 transition-all ">Create</a>
                        </div>
                      </div>
                    </div>
                    ...
                    <form id="bulk-action-form" action="{{ route('bulk.action.table') }}" method="POST">
                        @csrf
                                    ...
                                    {{-- @forelse ($tables as $table)
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td class="px-6 py-4 flex gap-3">
                                                ...
                                                <form action="{{ route('table.destroy', $table->id) }}" method="POST"  onsubmit="return confirm('yakin mau hapus?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="flex items-center">
