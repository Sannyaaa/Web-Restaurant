                ...
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-full max-w-full px-3">
                    ...
                    <div class="relative overflow-x-auto">
                        <form action="{{ route('table.update',$table->id) }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    ...
                                    <div class="p-5 border mt-5 w-fit rounded">
                                        <img src="{{ Storage::url($table->qr_code) }}" alt="">
                                    </div>
                                </div>
                                <div class="md:col-span-5">
                                    <label for="name">Name <span class="text-rose-500">*</span></label>
                                    <input type="text" name="name" id="name" value="{{ $table->name }}" class="h-10 border-4 border-slate-900 mt-1 rounded-md py-5 px-4 w-full bg-gray-50" />
                                    @error('name')
                                ...
                                <div class="md:col-span-5">
                                    ...
                                    <input type="file" name="qr_code" id="qr_code" value="{{ $table->qr_code }}" class="h-12 pt-2 border-4 border-slate-900 mt-1 rounded-md px-4 w-full bg-gray-50" value="" placeholder="email@domain.com" />
                                    @error('qr_code')
                                        <div class="my-4 py-4 px-6 bg-rose-200 rounded-lg">
                                            <div class="alert alert-success text-md text-rose-700">
                                                {{ $message }}
